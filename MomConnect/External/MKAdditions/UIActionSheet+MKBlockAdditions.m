...
+(void) actionSheetWithTitle:(NSString*) title
                     message:(NSString*) message
                     buttons:(NSArray*) buttonTitles
      destructiveButtonIndex:(NSNumber*) destructiveIndex
                  showInView:(UIView*) view
                   onDismiss:(DismissBlock) dismissed
                    onCancel:(CancelBlock) cancelled
{
    ...
    if (destructiveIndex && [destructiveIndex isKindOfClass:[NSNumber class]] && destructiveIndex.integerValue < buttonTitles.count) {
        actionSheet.destructiveButtonIndex = destructiveIndex.integerValue;
    }
